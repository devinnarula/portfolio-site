        ...
        <header className='Header'>
            ...
            <nav className='Header-Navbar'>
                <ul className='Header-NavList'>
                    ...
                    <li>
                        <Link className='Header-NavItem' activeClassName='Header-ActiveNavItem' href='https://drive.google.com/file/d/1gnTbWk2aFYIm_Yx72NZksM1M-a-pd-rL/view?usp=sharing' target='_blank'>
                            Resume
                        </Link>
                    </li>
                </ul>
